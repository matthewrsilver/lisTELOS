...
%                                                                              %
%   The Delayed Saccade Task test the ability to withold a reactive saccade,   %
%   as in the Overlap Task, and also the ability to produce a  memory-guided   %
%   saccade.   Memory-guided saccades are  characterized by longer latencies   %
%   than visually-guided saccades, wich is captured by this simulation.        %
%                                                                              %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %

function [fields data] = DelayedSaccadeTask
  ...
  disp('Running the Delayed Saccade Task (Simulation 1 of 1)')
  disp('**********************************************************')
  ...
  fixLocation = 41;
  cueLocation = 14;
  saccadeStep = round(DelayedTime/stepSize + 1);
  ...
  title('Cortical Cells in Delayed Saccade Task')
  ...
  [figx figy] = dsxy2figxy([15001 15001], [2 -37.5]); 
  annotation(gcf, 'line', [figx], [figy], 'LineStyle', ':');
  
  if ~isempty(saccadeStep)
  ...
  rectangle('Position', [5001 1 5000  .5], 'FaceColor', 'black')
  rectangle('Position', [1    2 15000 .5], 'FaceColor', 'black')
  title('Subcortical Cells in Delayed Saccade Task')
