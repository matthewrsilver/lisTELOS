...
%                                 Gap 500 Task                                 %
%                                                                              %
%   The Gap 500 Task is related to the Saccade (Gap 0) Task.   Both of these   %
%   tasks test the ability to fixate and then saccade reactively to a visual   %
%   cue.  In the Gap 500 task, however, there is a 500 ms time delay between   %
%   the offset of the  fixation point and the onset of the cue.   This delay   %
%   results in,  under certain conditions,  responses with  reduced latency.   %
%                                                                              %
%   The lisTELOS model reproduces the result because when the fixation point   %
%   disappears, fixation-related activity begins to subside. By the time the   %
%   cue is presented, the model is free to saccade reactively toward it, and   %
%   does not need to stage a competition between saccade plans.                %
%                                                                              %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %

function [fields data] = GapTask
  ...
  disp('Running the Gap 500 Task (Simulation 1 of 1)')
  disp('**********************************************************')
  ...
  fixLocation = 41;
  cueLocation = 14;
  saccadeStep = round(GapTime/stepSize +1);
  ...
  title('Cortical Cells in Gap 500 Task')
  ...
  rectangle('Position', [10001 1 5000 .5], 'FaceColor', 'black')
  rectangle('Position', [1    2  5000 .5], 'FaceColor', 'black')
  title('Subcortical Cells in Gap 500 Task')
