...
%                             Saccade (Gap 0) Task                             %
%                                                                              %
%   The saccade task tests the ability to fixate and then saccade reactively   %
%   toward a visual cue. Because the fixation point offset and the cue onset   %
%   are simultaneous,  the saccade task is characterized by a longer saccade   %
%   latency than the  gap 500 task,  in which subjects have been observed to   %
%   produce express saccades.                                                  %
%                                                                              %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %

function [fields data] = SaccadeTask
  ...
  disp('Running the Saccade (Gap 0) Task (Simulation 1 of 1)')
  disp('**********************************************************')
  ...
  fixLocation = 41;
  cueLocation = 14;
  saccadeStep = round(SaccadeTime/stepSize + 1);
  ...
  title('Cortical Cells in Saccade (Gap 0) Task')
  ...
  rectangle('Position', [5001 1 5000 .5], 'FaceColor', 'black')
  rectangle('Position', [1    2 5000 .5], 'FaceColor', 'black')
  title('Subcortical Cells in Saccade (Gap 0) Task')
