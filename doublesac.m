function [fields data] = doublesac
  ...
  stepSize     = 0.001;
  duration     = 40.0;
  cueLocations = [41     38    14];
  cueOnTimes   = [5      8     15];
  cueOffTimes  = [30     13    20];
  ...
  plot([0:stepSize:duration]/10, PYi(1:keynum, [41 38 14]), 'k');
  ylabel('P^Y_i');
  ...
  plot([0:stepSize:duration]/10, PLi(1:keynum, [41 38 14]), 'k');
  ylabel('P^L_i');
  ...
  for i = 1:length(cueLocations)-1
      ...
      if i < length(cueLocations)-1
          PCr(i, cueOnTimes(i+1)/stepSize+1:cueOnTimes(i+2)/stepSize+1)      ...
              = rowheight*(i-1)+pulseheight;
      else
          PCr(i, cueOnTimes(i+1)/stepSize+1:end)                             ...
              = rowheight*(i-1)+pulseheight;
      end
  end
  
  plot([0:stepSize:duration]/10, PCr, 'k');
  ylabel('P^C_r');
  ...
  plot([0:stepSize:duration]/10, Mir(1:keynum, [38 95]), 'k');
  ylabel('M_{ir}');  
  ...
  plot([0:stepSize:duration]/10, SYir(1:keynum, [38 95]), 'k');
  ylabel('S^Y_{ir}');
  ...
  plot([0:stepSize:duration]/10, SOi(1:keynum, [41 38 14]), 'k');
  ylabel('S^O_i');
  ...
  plot([0:stepSize:duration]/10, FOi(1:keynum, [41 38 14]), 'k');
  ylabel('F^O_i');
  ...
  plot([0:stepSize:duration]/10, GNi(1:keynum, [41 38 14]), 'k');
  ylabel('G^N_i');
  ...
  plot([0:stepSize:duration]/10, Ci(1:keynum, [41 38 14]), 'k');
  ylabel('C_i');
  xlabel('time (ms)')
  ...
  %subplot(9, 2, 1)
  %PLi = data(:, fields.PLi(3):fields.PLi(4));
  %plot([0:stepSize:duration]/10, PLi(1:keynum, fixLocation))
  %ylabel('P^L_F')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %subplot(9, 2, 3)
  %PLi = data(:, fields.PLi(3):fields.PLi(4));
  %plot([0:stepSize:duration]/10, PLi(1:keynum, cueLocation))
  %ylabel('P^L_T')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %subplot(9, 2, 5)
  %PYi = data(:, fields.PYi(3):fields.PYi(4));
  %plot([0:stepSize:duration]/10, PYi(1:keynum, fixLocation))
  %ylabel('P^Y_F')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %subplot(9, 2, 7)
  %PYi = data(:, fields.PYi(3):fields.PYi(4));
  %plot([0:stepSize:duration]/10, PYi(1:keynum, cueLocation))
  %ylabel('P^Y_T')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %subplot(9, 2, 9)
  %Mir = data(:, fields.Mir(3):fields.Mir(4));
  %plot([0:stepSize:duration]/10, Mir(1:keynum, cueLocation))
  %ylabel('M_{T1}')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %subplot(9, 2, 11)
  %SOi = data(:, fields.SOi(3):fields.SOi(4));
  %plot([0:stepSize:duration]/10, SOi(1:keynum, cueLocation))
  %ylabel('S^O_T')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %plot([0:stepSize:duration]/10, FPi(1:keynum, cueLocation))
  %ylabel('F^P_T')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %subplot(9, 2, 15)
  %FOi = data(:, fields.FOi(3):fields.FOi(4));
  %plot([0:stepSize:duration]/10, FOi(1:keynum, cueLocation))
  %ylabel('F^O_T')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %plot([0:stepSize:duration]/10, FXi(1:keynum, cueLocation))
  %ylabel('F^X_T')
  %axis([0 2 0 1])
  %set(gca, 'TickLength', [0; 0])
  ...
  %plot([0:stepSize:duration]/10, BNi(1:keynum, cueLocation))
  %ylabel('B^N_T')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %plot([0:stepSize:duration]/10, Ti(1:keynum, cueLocation))
  %ylabel('T_T')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %plot([0:stepSize:duration]/10, GDi(1:keynum, fixLocation))
  %ylabel('G^D_F')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %subplot(9, 2, 8)
  %GDi = data(:, fields.GDi(3):fields.GDi(4));
  %plot([0:stepSize:duration]/10, GDi(1:keynum, cueLocation))
  %ylabel('G^D_T')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %plot([0:stepSize:duration]/10, GIi(1:keynum, cueLocation))
  %ylabel('G^I_F')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %subplot(9, 2, 12)
  %GNi = data(:, fields.GNi(3):fields.GNi(4));
  %plot([0:stepSize:duration]/10, GNi(1:keynum, fixLocation))
  %ylabel('G^N_F')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %subplot(9, 2, 14)
  %GNi = data(:, fields.GNi(3):fields.GNi(4));
  %plot([0:stepSize:duration]/10, GNi(1:keynum, cueLocation))
  %ylabel('G^N_T')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  ...
  %subplot(9, 2, 16)
  %Ci = data(:, fields.Ci(3):fields.Ci(4));
  %plot([0:stepSize:duration]/10, Ci(1:keynum, fixLocation))
  %ylabel('C_F')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [])
  %set(gca, 'TickLength', [0; 0])
  ...
  %subplot(9, 2, 18)
  %Ci = data(:, fields.Ci(3):fields.Ci(4));
  %plot([0:stepSize:duration]/10, Ci(1:keynum, cueLocation))
  %ylabel('C_T')
  %axis([0 2 0 1])
  %set(gca, 'XTick', [0 .5 1 1.5 2])
  %set(gca, 'XTickLabel', {'0', '500', '1000', '1500', '2000'})
